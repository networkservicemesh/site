...
NSM v1.2.0 is now testing with [advanced healing examples](https://github.com/networkservicemesh/deployments-k8s/tree/v1.2.0/examples/heal) including simultanoues failure of two components.
...
### Stability
- Healing - improved Registry healing
