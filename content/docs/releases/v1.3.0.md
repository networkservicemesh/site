...
Example: https://github.com/networkservicemesh/deployments-k8s/tree/release/v1.3.0/examples/features/vl3
...
Examples for CNI Calico: https://github.com/networkservicemesh/deployments-k8s/tree/release/v1.3.0
...
Example: https://github.com/networkservicemesh/deployments-k8s/tree/release/v1.3.0/examples/features/mutually-aware-nses
